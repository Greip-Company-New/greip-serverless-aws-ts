...
#
# Orden: VPC -> IAM (compartido) -> Storage -> IAM backup -> Postgres (EC2)
#
...
echo ""
echo "[5/5] Desplegando EC2 PostgreSQL ..."
bash "${ROOT_DIR}/postgres-ec2/deploy.sh" ${PROFILE} ${REGION} ${OFFICE_IP} ${KEY_NAME}

echo ""
echo "=============================================="
echo " Infraestructura ${ENVIRONMENT} desplegada. Ver infra/README.md"
echo "=============================================="
